<#
.SYNOPSIS
Exports Microsoft Teams user activity.
.DESCRIPTION
Downloads Teams user activity metrics for adoption and support trend analysis.
...
.EXAMPLE
.\Get-M365TeamsUserActivityReport.ps1
.NOTES
...
New-Item -ItemType Directory -Path $OutputDirectory -Force | Out-Null
$path = New-ReportPath -Name 'M365-TeamsUserActivity'
$uri = "https://graph.microsoft.com/v1.0/reports/getTeamsUserActivityUserDetail(period='D$Days')"
