<#
.SYNOPSIS
Reports MFA and authentication registration status.
.DESCRIPTION
Exports registration readiness, MFA capability, passwordless capability, and registered methods.
...
.EXAMPLE
.\Get-M365MfaRegistrationReport.ps1
.NOTES
Required delegated scopes: AuditLog.Read.All
...
$path = New-ReportPath -Name 'M365-MfaRegistration'
$report | Sort-Object IsMfaRegistered,UserPrincipalName | Export-Csv $path -NoTypeInformation -Encoding UTF8
Write-Output $report
