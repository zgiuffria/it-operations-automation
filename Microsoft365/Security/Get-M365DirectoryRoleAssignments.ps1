<#
.SYNOPSIS
Reports active Microsoft Entra directory-role assignments.
.DESCRIPTION
Lists enabled directory roles and their assigned users, groups, or service principals.
...
.EXAMPLE
.\Get-M365DirectoryRoleAssignments.ps1
.NOTES
Required delegated scopes: RoleManagement.Read.Directory, Directory.Read.All
...
$path = New-ReportPath -Name 'M365-DirectoryRoleAssignments'
$report | Sort-Object RoleName,MemberDisplayName | Export-Csv $path -NoTypeInformation -Encoding UTF8
Write-Output $report
