<#
.SYNOPSIS
Exports mailbox usage details.
.DESCRIPTION
Downloads Microsoft 365 mailbox storage and activity details for capacity and inactivity review.
...
.EXAMPLE
.\Get-M365MailboxUsageReport.ps1
.NOTES
...
New-Item -ItemType Directory -Path $OutputDirectory -Force | Out-Null
$path = New-ReportPath -Name 'M365-MailboxUsage'
$uri = "https://graph.microsoft.com/v1.0/reports/getMailboxUsageDetail(period='D$Days')"
